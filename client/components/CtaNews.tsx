...
return(
    ...
    <article className='flex content-center   justify-center  flex-row font-aeonik  p-10'>
        <div className='bg-dark-silver flex  content-center '>
            ...
            <button className="bg-forest-green  md:mt-0 text-white ml-1 rounded-lg p-1 hover:bg-teal hover:text-dark-green hover:border-dark-green border "> Suscribirme</button>
