          ...
          <div key={place._id} className='flex flex-col'>
            ...
            <div className='bg-soft-green font-aeonik flex justify-between pl-10 p-2 pr-10 '>
              <div className='flex flex-col justify-center '>
                <Link
                  href='/'
                  className='text-black bg-white rounded-full p-4 m-1'
                >
                  <svg
                    ...
                    fill='currentColor'
                  >
                    <path d='M9 3H15L17 5H21C21.5523 5 22 5.44772 22 6V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V6C2 5.44772 2.44772 5 3 5H7L9 3Z'></path>
                  </svg>
                </Link>
            ...
            <div className='p-3'>
              <div className=' font-aeonik text-black p-4'>
                <h1 className=' m-5 font-aeonik text-black text-2xl'>
                  Descripción
                </h1>
                  ...
                  <div className='flex '>
                    ...
                    <div className='mr-6 mt-3'>
                      <button>
                        ...
                        >
                          <path
                            d='M0 32.1428L0 25.7143H2.89286L2.89286 32.1428H0ZM0 19.2857L0 12.8571H2.89286L2.89286 19.2857H0ZM0 6.42854L0 -3.8147e-05H2.89286L2.89286 6.42854H0Z'
                            fill='black'
                            fillOpacity='0.85'
                          />
                        </svg>
